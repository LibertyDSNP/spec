...
| `messageID` | keccak-256 hash of this archive entry fields, with blank messageID |  bytes3 | YES
...
### `messageID`
* bytes32
* The keccak-256 hash of all of the Archive Entry fields in a keccak-256 hash with the messageID field being blank.
In other words, produce the hash with messageID set to 0-length bytes, then set messageID to the result.
