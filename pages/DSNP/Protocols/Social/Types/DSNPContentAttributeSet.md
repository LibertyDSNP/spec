...
| ----- | ----------- | --------- | ------------- | ------------ | ------------ |
| announcementType | Announcement Type Enum (`9`) | enum | [decimal](../../Core/Serializations.md#decimal) | `INT32` | no |
...
| subject | DSNP Content URI of the attribute set subject | [DSNP Content URI](../../Core/Identifiers.md#dsnp-content-uri) | `UTF-8` | `UTF8` | YES |
